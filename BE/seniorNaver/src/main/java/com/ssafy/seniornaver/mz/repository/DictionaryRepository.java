...
public interface DictionaryRepository extends JpaRepository<Dictionary, Long> {
    ...
    @Query(value = "SELECT DISTINCT dict.* " +
            ...
            countQuery = "SELECT DISTINCT dict.* " +
                    ...
                    "AND dict.use_year < :year + 10"
            , nativeQuery = true)
    List<Dictionary> findAllCustom(@Param("keyword") String keyword, @Param("year") int year, Pageable pageable);
    ...
    @Query(value = "SELECT DISTINCT dict.* " +
            ...
            countQuery = "SELECT DISTINCT dict.* " +
                    ...
                    "AND dict.use_year < :year + 10"
            ,nativeQuery = true)
    List<Dictionary> findAllCustom(@Param("keyword") String keyword, @Param("year") int year);
